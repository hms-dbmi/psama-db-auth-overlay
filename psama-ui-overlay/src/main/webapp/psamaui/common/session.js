...
define(["jquery", "underscore", "common/styles"], function($, _){
	...
	return {
		...
		authenticated : function(userId, token, username, permissions, acceptedTOS, mustChangePassword, callback){
		...
		mustChangePassword : function(){
			return JSON.parse(sessionStorage.session).mustChangePassword;
		},
		privileges: function(){
